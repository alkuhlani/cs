...
@Named(value = "csPaMB")
@ViewScoped
public class CsPaMB implements Serializable {
    ...
    private CsPa item;
    private List<CsPa> items;
    
    @Inject
    private CsPaBean bean;
    ...
    public void setItem(CsPa item) {
        this.item = item;
    }

    public List<CsPa> getItems() {
        return items;
    }

    public void setItems(List<CsPa> items) {
        this.items = items;
    }
